#ifndef __SIMPLE_PALETTE__
#define __SIMPLE_PALETTE__
...
class SimplePalette:public PenBoxInterface, public InterfacePlugin
{
    Q_OBJECT
    ...
    public:
        ...
        virtual void createPlugin(QObject *parent, QString idParent,plugin::PluginsManager *manager)
        {
            ...
            else if(idParent.contains("ToolBox"))
            {
                    ...
                    if(tool!=0 && penEditor!=0)
                    {
                        ...
                        this->setToolTip( "Current pen" );
                        QHBoxLayout* hl = new QHBoxLayout;
                        QVBoxLayout *mainLayout = &(tool->getMainLayout());
                        mainLayout->addLayout(hl );
                        hl->addWidget( this );
                        manager->addPlugins(this, "SimplePalette");
        ...
        SimplePalette( plugin::PluginsManager * manager ):PenBoxInterface(),dialog( this )
        {
    ...
    private:
        ...
        void selectPen()
        {
            ...
            dialog.setWindowTitle( "Selection of pen" );
